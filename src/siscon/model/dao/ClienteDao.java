 ...
 * @author Jose Luiz
 */
public class ClienteDao extends ConexaoMySql implements IClienteDao {
    ...
    public int salvarClienteDAO(ClienteModel pClienteModel) {
        try {
            ...
            return this.insertSQL(
                    ...
                    + "cli_email"
                    + ") VALUES ("
                    + "'" + pClienteModel.getCliNome() + "',"
                    + "'" + pClienteModel.getCliRua() + "',"
                    + "'" + pClienteModel.getCliNumero() + "',"
                    + "'" + pClienteModel.getCliBairro() + "',"
                    + "'" + pClienteModel.getCliCidade() + "',"
                    + "'" + pClienteModel.getCliUf() + "',"
                    + "'" + pClienteModel.getCliCep() + "',"
                    + "'" + pClienteModel.getCliTelefone() + "',"
                    + "'" + pClienteModel.getCliCelular() + "',"
    ...
    public boolean atualizarClienteDAO(ClienteModel pClienteModel) {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "pk_id_cliente = '" + pClienteModel.getIdCliente() + "',"
                    + "cli_nome = '" + pClienteModel.getCliNome() + "',"
                    + "cli_endereco = '" + pClienteModel.getCliRua() + "',"
                    + "cli_numero = '" + pClienteModel.getCliNumero() + "',"
                    + "cli_bairro = '" + pClienteModel.getCliBairro() + "',"
                    + "cli_cidade = '" + pClienteModel.getCliCidade() + "',"
                    + "cli_uf = '" + pClienteModel.getCliUf() + "',"
                    + "cli_cep = '" + pClienteModel.getCliCep() + "',"
                    + "cli_telefone = '" + pClienteModel.getCliTelefone() + "',"
                    + "cli_celular = '" + pClienteModel.getCliCelular() + "',"
                    + "cli_email = '" + pClienteModel.getCliEmail() + "'"
                    + " WHERE "
                    + "pk_id_cliente = '" + pClienteModel.getIdCliente() + "'"
                    + ";"
            );
