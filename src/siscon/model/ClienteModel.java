...
public class ClienteModel {
    ...
    /**
     * @param cliCelular the cliCelular to set
     */
    ...
    public String toString() {
        return "ClienteModel{" + "idCliente=" + idCliente + ", cliNome=" + cliNome + ", cliRua=" + cliRua + ", cliNUmero=" + cliNumero + ", cliBairro=" + cliBairro + ", cliCidade=" + cliCidade + ", cliUf=" + cliUf + ", cliCep=" + cliCep + ", cliTelefone=" + cliTelefone + ", cliCelular=" + cliCelular + ", cliEmail=" + cliEmail + '}';
    }
